...
public static class GoKitTweenExtensions
{
    ...
    public static GoTween floatPropertyTo( this Material self, string propertyName, float duration, float endValue )
    {
        return Go.to( self, duration, new GoTweenConfig().materialProperty( propertyName, endValue ) );
    }
    #endregion
